...
const isActiveStyle = "flex text-blue-800 items-center px-5 gap-3 font-semibold border-r-2 border-blue-500 transition-all duration-200 ease-in-out capitalize"
